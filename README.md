...
- **[2026-02-15] 리스너 최적화 및 가독성 확보**: Byte Buddy 상세 로그를 비활성화하여 비즈니스 로그만 깔끔하게 출력하도록 개선. [cite: 2026-02-15]
...
| :--- | :--- | :--- |
| **02-15** | **.gitignore 무시 현상** | 이미 Git 인덱스에 포함된 파일은 무시되지 않음 -> `git rm -r --cached .`으로 전체 캐시 초기화 후 재등록. [cite: 2026-02-15] |
